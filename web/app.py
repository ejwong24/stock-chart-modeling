...
PIPELINE_DEEPDIVES = {
    ...
    "27_sharpe_ratio": "Sharpe ratio — definition, interpretation, common mistakes",
    "28_cagr_drawdown_calmar": "CAGR, maximum drawdown, and the Calmar ratio",
    "29_fixed_log_y_axis": "The fixed log-y axis (−90% to +1000%)",
    "30_isotonic_calibration": "Isotonic calibration — recovering probabilities",
    "31_lightgbm_internals": "LightGBM internals — how gradient boosting finds splits",
    "32_position_size_formula": "Position size — the min(equity×pct, max_adv×adv, cash) formula",
    "33_adv20_metric": "Average Daily Volume — the ADV20 metric",
    "34_blotter_equity_summary": "The blotter, the equity curve, and the summary",
    "35_log_vs_simple_returns": "Log returns vs simple returns — when each is correct",
    "36_allocation_budget": "The allocation budget — 5 × 4% × 5 cohorts = 100% deployed",
    "37_trading_calendar": "The trading calendar — Fridays, holidays, half-days",
    "38_spy_beta": "Market beta — what beta_spy_63d measures",
    "39_hardening_story": "The hardening story — 21 bugs across 18 passes",
    "40_lookahead_exit_bug": "Look-ahead in the exit fill — the price-gap bug",
    "41_row_alignment": "The row-alignment landmine — arrays and DataFrames in lockstep",
    "42_beta_zero_bug": "Why beta_spy_63d was silently zero — a dead-code feature",
    "43_label_corruption": "Non-positive prices and label corruption — when inf becomes a buy signal",
    "44_numerical_stability": "Numerical stability patterns across the pipeline",
    "45_testing_philosophy": "Testing philosophy — why finite-value tests let a dead feature live",
    "46_forward_pick_harness": "The forward paper-trading harness — live picks without look-ahead",
    "47_roadmap": "Feature gaps & roadmap — what's missing and what to build next",
    "48_degenerate_folds": "Degenerate folds — PCA components, tiny samples, singleton classes",
